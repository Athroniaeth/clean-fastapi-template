...
from rename.commands.dataset import get_service_dataset
...
async def get_service_tokenizer():  # noqa
    ...
    from rename.infrastructure.repositories.tokenizer import TokenizerRepository

    from rename.settings import get_storage_infra
    from rename.application.tokenizer import TokenizerService
