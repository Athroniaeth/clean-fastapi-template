...
from rename.commands.api_keys import cli_keys
from rename.commands.dataset import cli_dataset
from rename.commands.ml import cli_ml
from rename.commands.tokenizer import cli_tokenizer
from rename.commands.users import cli_users
...
@cli.command()
def dev(
    source: str = typer.Option("rename.api.app:factory_app"),
